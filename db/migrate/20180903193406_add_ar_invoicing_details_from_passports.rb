class AddArInvoicingDetailsFromPassports < ActiveRecord::Migration[5.1]
  def up
    ...
    query.each do |person|
      ...
      id_to_use = ids.where(identification_kind_id: 1).first
